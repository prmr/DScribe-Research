 ...
 * @dscribe IF charsetUnsupported, THEN java.nio.charset.UnsupportedCharsetException is thrown
 * @dscribe IF charsetNameIllegal, THEN java.nio.charset.IllegalCharsetNameException is thrown
 */

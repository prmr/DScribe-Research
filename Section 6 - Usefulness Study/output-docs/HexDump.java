...
public class HexDump {
    ...
    /**
 * 
 * @dscribe IF streamWriteIOException OR streamFlushIOException, THEN java.io.IOException is thrown
 * @dscribe IF indexNegative OR indexTooLarge, THEN java.lang.ArrayIndexOutOfBoundsException is thrown
 * @dscribe IF streamNull, THEN java.lang.IllegalArgumentException is thrown
 */

 ...
 * @dscribe IF readerNull, THEN java.lang.IllegalArgumentException is thrown
 */
 ...
 * @dscribe IF IOException, THEN java.lang.IllegalStateException is thrown
 */
    @Override
 ...
 * @dscribe IF IOExceptionHasNext, THEN java.lang.IllegalStateException is thrown
 * @dscribe IF noMoreLines, THEN java.util.NoSuchElementException is thrown
 */
    @Override
    public String next() {
        return nextLine();
 ...
 * @dscribe IF IOException, THEN java.io.IOException is thrown
 */
    @Override
 ...
 * @dscribe IF always, THEN java.lang.UnsupportedOperationException is thrown
 */
    @Override
    public void remove() {

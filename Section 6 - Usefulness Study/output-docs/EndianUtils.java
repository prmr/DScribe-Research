 ...
 * @dscribe IF byteArray_offsetNegative OR byteArray_offsetTooLarge, THEN java.lang.ArrayIndexOutOfBoundsException is thrown
 * @dscribe IF byteArray_dataNull, THEN java.lang.NullPointerException is thrown
 */
 ...
 * @dscribe IF outputStream_outputNull, THEN java.lang.NullPointerException is thrown
 * @dscribe IF outputStream_writeIOError, THEN java.io.IOException is thrown
 */
 ...
 * @throws IOException in case of an I/O problem
 * @dscribe IF inputStream_unexpectedEOF OR inputStream_readIOError, THEN java.io.IOException is thrown
 * @dscribe IF inputStream_inputNull, THEN java.lang.NullPointerException is thrown
 */
